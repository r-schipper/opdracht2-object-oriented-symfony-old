...
class XmlHandlerTest extends TestCase
{
    public function testArrayToXml()
    {
        ...
        $accommodaties_xml = $xml_handler->arrayToXml($accommodaties, ['accommodatie', 'land', 'skigebied', 'plaats', 'afbeelding']);

        $accommodaties_from_xml = $serializer->deserialize($accommodaties_xml, 'App\Entity\Accommodatie[]', 'xml');
